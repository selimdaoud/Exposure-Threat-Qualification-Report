            ...
            for table in tables:
                ...
                for row in table:
                    ...
                    if title:
                        ...
                        if canonical:
                            # Update the current product but PRESERVE col_map:
                            # multiple product sections in the same table share
                            # the same column layout (header is defined once at
                            # the top of the table and applies to all sections).
